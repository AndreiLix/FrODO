...
def step_v2(x, z, fs_private, beta= 0.2, alpha= 3, a= 1, h= 1e-2, subgradient= "autograd"):
    """
...
def plot_streamlined(alphas, betas, hs, n_iterations= 100, subgradient= "autograd", step_version= "step_v2"):
